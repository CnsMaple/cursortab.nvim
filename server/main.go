...
type ProviderConfig struct {
	Type                 string          `json:"type"` // "inline", "fim", "sweep", "sweepapi", "zeta-2", "zeta", "copilot", "mercuryapi"
	URL                  string          `json:"url"`
...
func (c *Config) Validate() error {
	if err := validateEnum(c.Provider.Type, "provider.type", []string{"inline", "fim", "sweep", "sweepapi", "zeta-2", "zeta", "copilot", "mercuryapi"}); err != nil {
		return err
	}
